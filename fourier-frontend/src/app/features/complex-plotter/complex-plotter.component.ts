...
export const COMPLEX_LIBRARY_GROUPS: CLibGroup[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      e('K(z)', 'K\\left(z\\right)', 'fresnelK(z)', 'K = ∫₀ᶻ exp(−iξ²)dξ'),
      e('C(z)+iS(z)', 'C\\left(z\\right)+iS\\left(z\\right)', 'fresnelC(z)+%i*fresnelS(z)', 'Espiral de Cornu'),
      e('K(z²)', 'K\\left(z^{2}\\right)', 'fresnelK(z^2)'),
      e('K(iz)', 'K\\left(iz\\right)', 'fresnelK(%i*z)', 'K en eje imaginario'),
      e('K(z)/z', '\\frac{K\\left(z\\right)}{z}', 'fresnelK(z)/z'),
      e('K(z)·exp(iz²)', 'K\\left(z\\right)e^{iz^{2}}', 'fresnelK(z)*exp(%i*z^2)', 'Modulación cuadrática'),
