  ...
  readonly groups: FnGroup[] = [
    ...
    },
    {
      ...
      entries: [
        ...
        { label: 'Shi(z)',         fn: 'Shi(z)',           desc: 'Seno hiperbólico integral' },
        { label: 'Chi(z)',         fn: 'Chi(z)',           desc: 'Coseno hiperbólico integral' },
        { label: 'Si(z)/z',        fn: 'Si(z)/z' },
        { label: 'Ci(z)·Si(z)',    fn: 'Ci(z)*Si(z)' },
        { label: 'Si(z)+i·Ci(z)', fn: 'Si(z)+i*Ci(z)',   desc: 'Relacionada con Ei' },
        { label: 'Shi(z)+i·Chi(z)',fn: 'Shi(z)+i*Chi(z)' },
      ],
    },
    {
      id: 'fresnel',
      label: 'Fresnel compleja',
      entries: [
        { label: 'K(z)',           fn: 'fresnelK(z)',      desc: 'K(z) = ∫₀ᶻ exp(−iξ²)dξ' },
        { label: 'Re K(z)',        fn: 'fresnelC(z)',      desc: 'Fresnel C(z): parte real de K' },
        { label: 'Im K(z)',        fn: 'fresnelS(z)',      desc: 'Fresnel S(z): parte imaginaria de K' },
        { label: 'K(z²)',          fn: 'fresnelK(z^2)' },
        { label: 'K(iz)',          fn: 'fresnelK(i*z)',    desc: 'K en eje imaginario' },
        { label: 'K(z)/z',         fn: 'fresnelK(z)/z' },
        { label: 'K(z)·exp(iz²)', fn: 'fresnelK(z)*exp(i*z^2)', desc: 'Modulación cuadrática' },
      ],
    },
    {
      id: 'gamma-extra',
      label: 'Beta y factorial',
      entries: [
        { label: 'z!',             fn: 'factorial(z)',     desc: 'factorial(z) = Γ(z+1)' },
        { label: 'B(z,2)',         fn: 'beta(z,2)',        desc: 'Beta compleja, b=2' },
        { label: 'B(z,½)',        fn: 'beta(z,0.5)',      desc: 'B(z,½) = √π·Γ(z)/Γ(z+½)' },
        { label: 'B(z,z)',         fn: 'beta(z,z)' },
        { label: 'B(z,1−z)',      fn: 'beta(z,1-z)',     desc: 'Fórmula de reflexión' },
        { label: '1/factorial(z)', fn: '1/factorial(z)' },
        { label: 'factorial(z)·sin(πz)', fn: 'factorial(z)*sin(3.14159*z)', desc: 'Relacionada con Γ' },
      ],
    },
    {
      id: 'composed',
